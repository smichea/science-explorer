...
- **Les noms sur la carte** : avec près de quatre-vingt-dix destinations, la carte n'écrit que ce qu'elle peut écrire lisiblement — les trois mondes, les régions les plus fournies, puis les destinations les plus importantes de la zone regardée. Zoomer en fait apparaître d'autres ; passer le pointeur (ou le focus clavier) sur une destination affiche son nom, et la vue liste les donne tous.
